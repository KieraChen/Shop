			...
			<div class="nav-table">
					   ...
					   <div class="nav-cont">
							<ul>
                                ...
                                <li class="qc last"><a href="${pageContext.request.contextPath }/product/List.do?csid=${product.csId}">
                                <c:forEach items="${cs}" var="catecorysecond">
									<c:forEach items="${catecorysecond}" var="cs2">
										<c:if test="${cs2.csId == product.csId }">
										    ${cs2.csName }
										</c:if>
									</c:forEach>
								</c:forEach>
				 ...
				 ${product.pName }
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">${product.shopPrice }</b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>市场价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">${product.marketPrice }</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															...
															<input id="text_box" name="count" type="number" min="1" value="1" style="width:30px;" />
						...
						<div class="pay">
							...
							<li>
								...
								<input id="product" name="product.pId" type="hidden" value="${product.pId }">
								<input id="product" name="product.pName" type="hidden" value="${product.pName }">
								<input id="product" name="product.marketPrice" type="hidden" value="${product.marketPrice }">
								<input id="product" name="product.shopPrice" type="hidden" value="${product.shopPrice }">
								<input id="product" name="product.image" type="hidden" value="${product.image }">
								<input id="product" name="product.pDesc" type="hidden" value="${product.pDesc }">
								<input id="product" name="product.isHot" type="hidden" value="${product.isHot }">
								<%-- <input id="product" name="product.pDate" type="hidden" value="${product.pDate }"> --%>
								<input id="product" name="product.csId" type="hidden" value="${product.csId }">
								
								
									<input id="LikBuy" type="button" value="立即购买" title="点此按钮到下一步确认购买信息" onclick="goOrder()"/>
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									...
									<input id="LikBasket" type="button" value="加入购物车" title="加入购物车" onclick="goShopCart()"/>
